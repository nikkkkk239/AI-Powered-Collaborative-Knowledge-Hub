    ...
    <Layout>
      <div className="max-w-4xl mx-auto space-y-6">
        <div className='slide-down-in'>
          <h1 className="text-2xl font-bold text-gray-900">Team <span className='text-blue-700'>Q&A</span></h1>
        ...
        {/* Question Input */}
        <div className="bg-white slide-down-in rounded-lg shadow-sm border border-gray-200 p-6">
